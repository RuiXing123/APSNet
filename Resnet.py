...
from ChannelAttention import ECA
from FrequencySeparation import FrequencySeparation
...
class ResNet_SACON_ConRes(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        self.CBR0 = nn.Sequential(nn.Conv2d(1, 1, 7, 2,3),
                                 nn.BatchNorm2d(1),
                                 nn.ReLU())
        self.CBR1 = nn.Sequential(nn.Conv2d(1, 1, 3, 2,1),
                                 nn.BatchNorm2d(1),
                                 nn.ReLU())
        self.CBR2 = nn.Sequential(nn.Conv2d(1, 1, 1, 1),
                                  nn.BatchNorm2d(1),
                                  nn.ReLU())
